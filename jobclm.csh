...
#-------------------------------------------------------
set CASE_NAME   = CLMExample           	# case name                                            <MARK #1>
...
set END_DAY     = 50             	# model end Julian day
...
# clm src directory
#-------------------------------------------------------
setenv CLM_ROOT   $HOME/CoLM/colm2014_src/clm                              # <MARK #3>
...
# inputdata directory
setenv DAT_ROOT   $HOME/CoLM/data/inputdata                                # <MARK #4>
setenv DAT_RAWDIR $HOME/CoLM/data/CLMrawdata         
setenv DAT_ATMDIR $DAT_ROOT/atm/cruncep
setenv DAT_SRFDIR $DAT_ROOT/srf/global_0.5x0.5
setenv DAT_RTMDIR $DAT_ROOT/rtm

# case directory
#-------------------------------------------------------
setenv CAS_ROOT   $HOME/CoLM/cases                                         # <MARK #5>
