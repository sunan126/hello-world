...
! ----------------local variables ---------------------------------
      ...
      integer :: lon_start        ! longitude start index on model grids
      integer :: lat_start        ! latitude start index on model grids
...
!-----------------------
    ...
    ! Initialize meteorological forcing data module
      CALL GETMETINI(dir_forcing, deltim, lat_points, lon_points, lat_start, lon_start)
